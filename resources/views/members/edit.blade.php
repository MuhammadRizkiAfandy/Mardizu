...
<body class="container mt-5">
    ...
    <form action="{{ route('members.update', $member->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="date" name="birth_date" id="birth_date" class="form-control" value="{{ old('birth_date', $member->birth_date) }}">
        </div>
        ...
        fetch('https://www.emsifa.com/api-wilayah-indonesia/api/provinces.json')
            ...
            .then(data => {
                ...
                if (oldProvinceId) {
                    ...
                    loadRegencies(oldProvinceId, "{{ old('regency_id', $member->regency_id) }}");
                }
            })
            .catch(() => {
